    ...
    <Html lang="en">@types/react@18.2.0
      <Head>
        ...
        <meta
          name="keyword"
          content={
            "cuben, campus market, cuben.uz, student market, buy sell items, second-hand"
          }
        />
        ...
        <meta
          ...
          content={
            ...
            // Ruscha
            "Cuben — студенческий маркетплейс для покупки и продажи подержанных вещей: книги, электроника, одежда и многое другое внутри кампуса. Удобно, быстро и безопасно. | " +
            // Koreyscha
