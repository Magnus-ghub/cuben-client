						...
						<Stack className="description-box">
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										value={insertPropertyData.productRooms || 'select'}
										defaultValue={insertPropertyData.productRooms || 'select'}
										onChange={({ target: { value } }) =>
								...
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										value={insertPropertyData.productBeds || 'select'}
										defaultValue={insertPropertyData.productBeds || 'select'}
										onChange={({ target: { value } }) =>
								...
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										value={insertPropertyData.productSquare || 'select'}
										defaultValue={insertPropertyData.productSquare || 'select'}
										onChange={({ target: { value } }) =>
