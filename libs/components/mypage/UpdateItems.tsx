...
const UpdateItems: NextPage = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (itemType === 'product') {
        ...
        await updatePost({ variables: { input: updateData } });
        ...
        await updateArticle({ variables: { input: updateData } });
  ...
  if (device === 'mobile') {
    return <div>UPDATE ITEMS MOBILE VERSION (not implemented yet)</div>;
  }

  const getIcon = () => {
    switch (itemType) {
      case 'product': return <Package size={24} />;
      case 'post':    return <FileText size={24} />;
  ...
  const getTitle = () => {
    switch (itemType) {
      ...
      case 'article': return 'Edit Article';
          ...
          {itemType === 'product' && (
            <>
              <Box className="form-section">
                ...
                <TextField
                  fullWidth
                  placeholder="iPhone 17 Pro, MacBook Air M3, etc."
              ...
              <Stack direction="row" spacing={2}>
                ...
                <Box className="form-section" sx={{ flex: 1 }}>
                  <label className="section-label">Address / Meet-up Location</label>
                  <TextField
                    fullWidth
                    placeholder="Compose cafe, PNU library, etc."
              ...
              <Box className="form-section">
                ...
                <TextField
                  ...
                  multiline
                  rows={8}
                  placeholder="Brand new iPhone 17. Excellent condition, smooth performance, battery health 98%. Ready to use..."
