...
const TViewer: React.FC<TViewerProps> = ({ markdown, html, className }) => {
    // 1. useEditor'ni to'g'ridan-to'g'ri chaqiramiz
    const editor = useEditor({
        ...
        editable: false,
        // 2. MUHIM: SSR xatosini yo'qotish uchun mana bu qatorni qo'shing:
        immediatelyRender: false, 
    }, [markdown, html]); // Dependency array'ga kontentni qo'shing

    // Kontent yo'q bo'lsa yoki editor hali yuklanmagan bo'lsa
    if (!editor || (!markdown && !html)) {
        return (
