      ...
      <Stack className={"find-your-home"} mb={"30px"}>
        ...
        <Stack className={"input-box"}>
            ...
            <label htmlFor={"Barter"} style={{ cursor: "pointer" }}>
                <Typography className="propery-type">Barter</Typography>
            </label>
        </Stack>
        <Stack className={"input-box"}>
            <Checkbox
            ...
            <label htmlFor={"Rent"} style={{ cursor: "pointer" }}>
                <Typography className="propery-type">Rent</Typography>
            </label>
        </Stack>
      </Stack>
      <Stack className={"find-your-home"} mb={"30px"}>
        ...
        <Stack className="square-year-input">
            <input 
                ...
                onChange={(e: any) => {
                    ...
                    if (e.target.value >= 0) {
                        setPropertPrice({ ...propertyPrice, start: e.target.value });
                    }
                }}
            />
            <div className="central-divider"></div>
            <input 
                ...
                onChange={(e: any) => {
                    console.log("value: ", e.target.value);
                    if (e.target.value >= 0) {
                        setPropertPrice({ ...propertyPrice, end: e.target.value });
                    }
                }}
            />
        </Stack>
